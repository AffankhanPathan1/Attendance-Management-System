                ...
                <div class="card-body">
                  <form method="post">
                    <div class="form-group row mb-3">
                        ...
                        <?php
                        $qry= "SELECT * FROM students where classId = '$_SESSION[classId]' and classDivId = '$_SESSION[classDivId]' ORDER BY firstName ASC";
                  ...
                  <?php
                    ...
                    if(isset($_POST['view'])){
                       ...
                       if($type == "1"){ //All Attendance
                        ...
                        where attendance.admissionNo = '$admissionNumber' and attendance.classId = '$_SESSION[classId]' and attendance.classDivId = '$_SESSION[classDivId]'";
                       ...
                       if($type == "2"){ //Single Date Attendance
                        ...
                        INNER JOIN term ON term.Id = sessionterm.termId
                        INNER JOIN students ON students.admissionNumber = attendance.admissionNo
                        where attendance.dateTimeTaken = '$singleDate' and attendance.admissionNo = '$admissionNumber' and attendance.classId = '$_SESSION[classId]' and attendance.classDivId = '$_SESSION[classDivId]'";
                       ...
                       if($type == "3"){ //Date Range Attendance
                        ...
                        INNER JOIN term ON term.Id = sessionterm.termId
                        INNER JOIN students ON students.admissionNumber = attendance.admissionNo
                        where attendance.dateTimeTaken between '$fromDate' and '$toDate' and attendance.admissionNo = '$admissionNumber' and attendance.classId = '$_SESSION[classId]' and tblattendance.classDivId = '$_SESSION[classDivId]'";
