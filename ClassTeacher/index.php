      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Class Teacher Dashboard (<?php echo $rrw['className'].' - '.$rrw['classDivName'];?>)</h1>
            <ol class="breadcrumb">
          ...
          <?php 
$query1=mysqli_query($conn,"SELECT * from students where classId = '$_SESSION[classId]' and classDivId = '$_SESSION[classDivId]'");                       
...
?>
            ...
            <!-- Earnings (Annual) Card Example -->
             <?php 
$query1=mysqli_query($conn,"SELECT * from classDiv");                       
$classDiv = mysqli_num_rows($query1);
?>
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card h-100">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $classDiv;?></div>
                      <div class="mt-2 mb-0 text-muted text-xs">
            ...
            <?php 
$query1=mysqli_query($conn,"SELECT * from attendance where classId = '$_SESSION[classId]' and classDivId = '$_SESSION[classDivId]'");                       
