...
//session and Term
        ...
        if (isset($_POST['save'])) {
          // Debug line to check if the date is received
        ...
        if($count == 0){ //if Record does not exsit, insert the new record
          ...
          {
              $qquery=mysqli_query($conn,"insert into attendance(firstName,lastName,admissionNo,classId,classDivId,sessionTermId,status,dateTimeTaken) 
              value('$ros[firstName]','$ros[lastName]','$ros[admissionNumber]','$_SESSION[classId]','$_SESSION[classDivId]','$sessionTermId','0','$dateTaken')");
        ...
        //if($count == 0){ //if Record does not exsit, insert the new record
         ...
         // while ($ros = $qus->fetch_assoc())
          //{
              //$qquery=mysqli_query($conn,"insert into record(admissionNo,classId,classDivId,sessionTermId,status,dateTimeTaken) 
