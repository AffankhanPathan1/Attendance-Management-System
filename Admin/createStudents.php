...
if(isset($_POST['save'])){
  ...
  $dateCreated = date("Y-m-d");
    ...
    $query=mysqli_query($conn,"select * from students where admissionNumber ='$admissionNumber'");
    ...
    $query=mysqli_query($conn,"insert into students(firstName,lastName,admissionNumber,password,classId,classDivId,dateCreated) 
    value('$firstName','$lastName','$admissionNumber','12345','$classId','$classDivId','$dateCreated')");
...
//--------------------EDIT------------------------------------------------------------
 ...
 $query=mysqli_query($conn,"update students set firstName='$firstName', lastName='$lastName', admissionNumber='$admissionNumber',password='12345', classId='$classId',classDivId='$classDivId'
    where Id='$Id'");
            if ($query) {
            ...
            <div class="col-lg-12">
              ...
              <div class="card mb-4">
                ...
                <div class="table-responsive p-3">
                  ...
                  <?php
                      $query = "SELECT students.Id,class.className,classDiv.classDivName,classDiv.Id AS classDivId,students.firstName,
